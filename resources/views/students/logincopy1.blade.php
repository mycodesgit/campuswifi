    ...
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand-md navbar-light">
            <div class="container-fluid">
                <a href="" class="navbar-brand" style="color: #000;font-family: Courier;">
                    CPSU CAMPUS WIFI
                </a>
                ...
                <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="#" role="button" style="color: #000">
                            v1 
                        </a>
                    </li>
                </ul>
                                ...
                                <div class="card-body">
                                    <form action="{{route('postLogin')}}" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" id="studID_no" name="stud_id" placeholder="0000-0000-K" class="form-control cred" data-widget="control-sidebar" data-slide="true" autofocus>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="password" id="password" name="password" placeholder="Password" class="form-control cred" autofocus>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <button type="submit" class="btn btn-success btn-block" style="border-radius: 20px">
